  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="item">
        <img src="img/okay8.jpg" alt="New York" style="width:100%;">
        
      </div>
     
	<div class="item active">
        <img src="img/okay4.jpg" alt="Los Angeles" style="width:100%;">
        
      </div>

      <div class="item">
        <img src="img/okay7.jpg" style="width:100%;">
        
      </div>
       
	 <div class="item">
        <img src="img/okay9.jpg" alt="New York" style="width:100%;">
