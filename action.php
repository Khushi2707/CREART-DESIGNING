                        ...
                        <div class='col-md-4 col-xs-6' >
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>Rs.990.00</del></h4>
									...
									<div class='add-to-cart'>
										...
										<br><br>
										<button  id='sharBtn' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-share-square'></i> share</button>
									</div>
								</div>
							</div>
			...
			echo "
                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' href='#' tabindex='0' class='add-to-cart-btn'><i class='fa fa-shopping-cart'></i> add to cart</button> <br><br>
										<button id='product' href='#' tabindex='0' class='add-to-cart-btn'><i class='fa fa-share-square'></i> Share</button>
									</div>
								</div>
							</div>
			";
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span>Rs.'.$product_price.'</h4>
												</div>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="creartdesigning2023@gmail.com">
